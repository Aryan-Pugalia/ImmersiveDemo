    ...
    >
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <div className="text-sm mt-1" style={{ color: "#666" }}>{data.address}</div>
        </div>
      ...
      {/* Line items header */}
      <div className="grid grid-cols-[1fr_50px_80px_80px] text-sm font-bold mb-2" style={{ color: "#555" }}>
      ...
      {data.items.map((item, i) => (
        <div key={i} className="grid grid-cols-[1fr_50px_80px_80px] text-sm py-1" style={{ borderBottom: "1px solid #eee", color: "#333" }}>
      ...
      {/* Totals */}
      <div className="mt-4 flex flex-col items-end text-sm space-y-1">
