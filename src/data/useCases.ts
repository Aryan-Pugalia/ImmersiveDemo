...
export const useCases: UseCase[] = [
  ...
  {
    id: "10-test",
    slug: "audio-annotation-test",
    title: "Audio Transcription & Translation (Test)",
    description: "Test environment — duplicate of the Audio Transcription & Translation use case. Safe sandbox for iterating on changes without affecting the production workflow.",
    icon: "mic",
    idTag: "AUD-401-T",
    categoryTag: "Speech / NLP",
    secondaryTag: "Test",
