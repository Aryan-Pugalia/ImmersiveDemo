                        ...
                        <td className="px-3 py-2 min-w-[130px]" onClick={e=>e.stopPropagation()}>
                          {readOnly
                            ...
                            : <textarea value={seg.sourceText} rows={2} dir={rtl?"rtl":"ltr"}
                                ...
                                className="w-full bg-transparent text-foreground/80 text-sm resize-none focus:outline-none placeholder-foreground/20"
                ...
                {segs.map(seg=>{
                  ...
                  return (
                    <div key={seg.id}
                      ...
                      aria-label={`Segment ${seg.speaker} at ${msToTC(seg.startMs)}`}
