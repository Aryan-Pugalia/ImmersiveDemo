...
// The video already has AI tracking overlaid (green box baked in).
// No additional canvas tracks are rendered — KEYFRAMES is intentionally empty.
      ...
      <div className="w-72 flex-shrink-0 space-y-4">
        ...
        <div className="rounded-2xl border border-blue-800/40 p-4" style={{ background: "rgba(37,99,235,0.10)" }}>
          ...
          <p className="text-sm text-foreground/60 leading-relaxed">
            ...
            model's live tracking output — rendered directly by the tracker. Watch for moments where
            the box drifts, freezes, or loses the target through obstacles.
          </p>
        </div>
