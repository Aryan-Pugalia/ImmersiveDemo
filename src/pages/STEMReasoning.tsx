...
// STAGE_LABELS is now sourced from i18n (sr.stageLabels) inside the component
...
const STEMReasoning = () => {
  ...
  const { t } = useLanguage();
  const sr = t.pages.stemReasoning;
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-black text-foreground mb-1">
          {sr.headingProblemPresentation}
        </h2>
        <p className="text-sm text-foreground/50">
          {sr.descriptionProblem}
        </p>
      </div>
      ...
      <div className="flex justify-center">
        ...
        >
          {sr.buttonReviewModelSolution} <ChevronRight size={16} />
        </button>
      </div>
    </div>
  );
  ...
  const renderStage2 = () => (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-black text-foreground mb-1">
          {sr.headingAiSolution}
        </h2>
        <p className="text-sm text-foreground/50">
          {sr.descriptionSolution}
        </p>
      </div>
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-5">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black text-foreground mb-1">
            {sr.headingAnnotation}
          </h2>
          <p className="text-sm text-foreground/50">
            {sr.descriptionAnnotation}
          </p>
        </div>
          ...
          <div className="lg:col-span-2 rounded-xl border border-border/20 bg-card p-5 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={sr.annotatorNotePlaceholder}
                rows={3}
            ...
            <div className="flex gap-2 pt-1">
              ...
              >
                <ChevronLeft size={13} /> {sr.buttonPrev}
              </button>
              {currentStep < STEPS.length - 1 ? (
                <button
                  ...
                  style={{ background: ACCENT }}
                >
                  {sr.buttonNext} <ChevronRight size={13} />
                </button>
              ) : (
                <button
                ...
                >
                  <Brain size={13} /> {sr.buttonSubmitToAi}
                </button>
              )}
            </div>
          </div>
  ...
  const renderStage4 = () => (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-black text-foreground mb-1">
          {sr.headingAiVerification}
        </h2>
        <p className="text-sm text-foreground/50">
          {sr.descriptionAiVerification}
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <button
              ...
              style={{ background: ACCENT }}
            >
              <Shield size={15} /> {sr.buttonForwardToQa}
            </button>
          </div>
        </div>
      )}
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="rounded-xl border border-border/20 bg-card p-5 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder={sr.placeholderQaNotes}
            rows={2}
            className="w-full text-xs rounded-lg border border-border/30 bg-background text-foreground px-3 py-2 resize-none focus:outline-none focus:border-violet-500 placeholder:text-foreground/30"
          />
        </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          style={{ background: ACCENT }}
        >
          <Award size={15} /> {sr.buttonFinalize}
        </button>
      </div>
    </div>
  );
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black text-foreground mb-1">
            {sr.headingFinalVerdict}
          </h2>
          <p className="text-sm text-foreground/50">
            {sr.descriptionFinalDelivery}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              label: "Review Status",
              value:
                status === "approved_for_training" ? sr.labelCorrect : sr.labelPartialLabel,
        ...
        <div className="rounded-xl border border-border/20 bg-card p-5">
          ...
          <div className="flex justify-end mt-3">
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-border/30 text-xs font-bold text-foreground/60 hover:text-foreground hover:border-border/60 transition">
              <Download size={13} /> {sr.buttonExportToClient}
            </button>
          </div>
        </div>
      </div>
      ...
      <header className={`sticky top-0 z-50 ${headerBg} relative`}>
        <div className="flex items-center justify-between px-4 py-3 h-14">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              <RefreshCw size={13} /> {sr.buttonResetDemo}
            </button>
